...
const ActionsResultsSection = ({
  ...
  return (
    <>
      <div className={styles.info}>検索結果: 全体 {paginationTotal} 件 / 現在 {actions.length} 件</div>
      ...
      <div className={styles.vizPanel}>
        ...
        {actionScatterPoints.length === 0 && <div className={styles.info}>数値化できる軸が無いため、散布図を描画できません。</div>}
